...
//go:generate minimock -i github.com/AiratS/micro_as_bigtech_course/week_3/internal/repository.NoteRepository -o note_repository_minimock.go -n NoteRepositoryMock -p mocks
