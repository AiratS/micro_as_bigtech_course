...
//go:generate minimock -i github.com/AiratS/micro_as_bigtech_course/week_3/internal/service.NoteService -o note_service_minimock.go -n NoteServiceMock -p mocks
...
type NoteServiceMock struct {
	...
	funcCreate          func(ctx context.Context, noteInfo *model.NoteInfo) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, noteInfo *model.NoteInfo)
...
func (mmCreate *mNoteServiceMockCreate) Expect(ctx context.Context, noteInfo *model.NoteInfo) *mNoteServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &NoteServiceMockCreateParams{ctx, noteInfo}
...
// ExpectNoteInfoParam2 sets up expected param noteInfo for NoteService.Create
func (mmCreate *mNoteServiceMockCreate) ExpectNoteInfoParam2(noteInfo *model.NoteInfo) *mNoteServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("NoteServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.noteInfo = &noteInfo
	mmCreate.defaultExpectation.expectationOrigins.originNoteInfo = minimock.CallerInfo(1)

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the NoteService.Create
func (mmCreate *mNoteServiceMockCreate) Inspect(f func(ctx context.Context, noteInfo *model.NoteInfo)) *mNoteServiceMockCreate {
...
func (mmCreate *mNoteServiceMockCreate) Set(f func(ctx context.Context, noteInfo *model.NoteInfo) (i1 int64, err error)) *NoteServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mNoteServiceMockCreate) When(ctx context.Context, noteInfo *model.NoteInfo) *NoteServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("NoteServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &NoteServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &NoteServiceMockCreateParams{ctx, noteInfo},
...
func (mmCreate *NoteServiceMock) Create(ctx context.Context, noteInfo *model.NoteInfo) (i1 int64, err error) {
	...
	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, noteInfo)
	}

	mm_params := NoteServiceMockCreateParams{ctx, noteInfo}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := NoteServiceMockCreateParams{ctx, noteInfo}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.noteInfo != nil && !minimock.Equal(*mm_want_ptrs.noteInfo, mm_got.noteInfo) {
				mmCreate.t.Errorf("NoteServiceMock.Create got unexpected parameter noteInfo, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originNoteInfo, *mm_want_ptrs.noteInfo, mm_got.noteInfo, minimock.Diff(*mm_want_ptrs.noteInfo, mm_got.noteInfo))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, noteInfo)
	}
	mmCreate.t.Fatalf("Unexpected call to NoteServiceMock.Create. %v %v", ctx, noteInfo)
	return
}
