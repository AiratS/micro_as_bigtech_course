...
import (
	...
	"github.com/AiratS/micro_as_bigtech_course/week_8/circuit_breaker/internal/interceptor"
	"github.com/AiratS/micro_as_bigtech_course/week_8/circuit_breaker/internal/metric"
	desc "github.com/AiratS/micro_as_bigtech_course/week_8/circuit_breaker/pkg/note_v1"
...
func main() {
	...
	cb := gobreaker.NewCircuitBreaker(gobreaker.Settings{
		...
		OnStateChange: func(name string, from, to gobreaker.State) {
			log.Printf("Circuit breaker: %s, changer from: %v, to: %v", name, from, to)
		},
	})
